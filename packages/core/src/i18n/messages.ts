...
export const PT_BR = {
  ...
  "panel.fixPreparing": "Preparando correções…",
  "panel.fixReady": "{n} de {total} correção(ões) pronta(s) para revisar.",
  "panel.fixFailed": "Falha ao gerar {n} de {total} correção(ões). Abra os detalhes para diagnosticar.",
...
const EN: Record<MessageKey, string> = {
  ...
  "panel.fixPreparing": "Preparing fixes…",
  "panel.fixReady": "{n} of {total} fix(es) ready for review.",
  "panel.fixFailed": "Failed to generate {n} of {total} fix(es). Open details to diagnose.",
...
const ES: Record<MessageKey, string> = {
  ...
  "panel.fixPreparing": "Preparando correcciones…",
  "panel.fixReady": "{n} de {total} corrección(es) lista(s) para revisar.",
  "panel.fixFailed": "No se pudieron generar {n} de {total} corrección(es). Abre los detalles para diagnosticar.",
