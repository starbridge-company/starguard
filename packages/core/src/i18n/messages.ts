...
export const PT_BR = {
  ...
  "scan.serverMemoryTooLow":
    "O {scanner} precisa de pelo menos {min} MB no contêiner; o limite detectado é {actual} MB. Ajuste os limites de recursos e recrie o contêiner.",
...
const EN: Record<MessageKey, string> = {
  ...
  "scan.serverMemoryTooLow":
    "{scanner} needs at least {min} MB in the container; the detected limit is {actual} MB. Adjust the resource limits and recreate the container.",
...
const ES: Record<MessageKey, string> = {
  ...
  "scan.serverMemoryTooLow":
    "El {scanner} necesita al menos {min} MB en el contenedor; el límite detectado es {actual} MB. Ajusta los límites de recursos y vuelve a crear el contenedor.",
